...
> 真实项目案例，展示如何高效使用 Claude Code 进行软件开发
> Real-world case studies demonstrating effective software development with Claude Code
...
这是一个**实战教程库**，记录了我与 Claude Code 协作开发真实项目的完整过程。通过这些案例，你将学到：
...
1. **[Claude Code 入门](tutorials/01-getting-started.md)**
   - Claude Code 是什么
   - 基本工作流程
   - 最佳实践和技巧

2. **[开源项目启动全流程](tutorials/02-open-source-project.md)** ⭐ 推荐
   - 7 天完成项目开源准备
   - 安全清理、文档建设、发布流程
   - 1,400+ 行实战记录 + 8 张截图
   - 真实案例：Code Health Monitor

3. **[Bug 追踪体系搭建](tutorials/03-bug-tracking-system.md)**
   - 知识库架构设计
   - Bug 记录模板和工作流
   - 项目级管理方案
...
**详细内容**：[查看案例](case-studies/code-health-monitor/)
...
从这里开始：**[开源项目启动全流程](tutorials/02-open-source-project.md)**
...
- **Claude Code 官方文档**: [anthropic.com/claude](https://www.anthropic.com/claude)
- **示例项目**: [Code Health Monitor](https://github.com/yzhucn/code-health)
...
1. **[Getting Started with Claude Code](tutorials/01-getting-started.md)**
   - What is Claude Code
   - Basic workflows
   - Best practices and tips

2. **[Complete Open-Source Project Launch](tutorials/02-open-source-project.md)** ⭐ Recommended
...
3. **[Building a Bug Tracking System](tutorials/03-bug-tracking-system.md)**
...
**Details**: [View Case Study](case-studies/code-health-monitor/)
...
Start here: **[Complete Open-Source Project Launch](tutorials/02-open-source-project.md)**
...
- **Claude Code Official**: [anthropic.com/claude](https://www.anthropic.com/claude)
- **Example Project**: [Code Health Monitor](https://github.com/yzhucn/code-health)
